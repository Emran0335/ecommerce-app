...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-light-100">
      <nav className="mx-auto h-16 flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8"
      aria-label="Primary"
      >
        <Link href="/" aria-label="Nike Home" className="">
          <Image
            src="/logo.svg"
            alt="Nike"
            width={28}
        ...
        <button
          className="flex-col items-center justify-center rounded-md p-2 md:hidden"
          type="button"

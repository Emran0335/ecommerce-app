  ...
  return (
    <footer className="bg-dark-900 text-light-100">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-12">
          <div className="flex items-start md:col-span-3">
            <Image src="/logo.svg" alt="Nike" width={28} height={28} />
          </div>

          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 md:col-span-7">
            {columns.map((col) => (
              <div key={col.title}>
                <h4 className="mb-3 text-heading-3">{col.title}</h4>
          ...
          <div className="flex gap-4 md:col-span-2 md:justify-end">
            {[
              ...
              <Link key={s.alt} href="#" aria-label={s.alt} className="inline-flex bg-light-100 h-10 w-10 items-center justify-center rounded-full">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl flex flex-col items-center justify-between gap-4 px-4 py-4 text-light-400 sm:flex-row lg:px-8">
          <div className="flex items-center gap-3 text-caption">
            <Image src="/globe.svg" alt="global" width={16} height={16} />
